...
const addContentFPPT = () => {
  ...
  element2.innerHTML =
    'คอร์ แอสเซท มุ่งเน้นบริหารจัดการดิจิตอลแอสเซท<br> <b style="color:rgba(15, 26, 92, 1); font-family: Anantason-Medium; font-size: 0.8rem;">สร้างระบบด้วยแนวคิด FPPT (เอฟ ดับเบิ้ลพี ที)</b><br>เพื่อจัดการบริหารธุรกิจและส่งเสริมการสร้างผลิตภัณฑ์<br>ในเครือของบริษัทคอร์ แอสเซท';
  element3.innerHTML =
    'ด้วยการนำ <b style="color:rgba(15, 26, 92, 1); font-family: Anantason-Medium; font-size: 0.8rem;">เทคโนโลยี ABBC<br>(เอดับเบิ้ลบีซี)</b>เข้ามาบริหารจัดการธุรกิจ<br>ให้เกิดการ Sharing Economic บน Eco system ของตนเอง เพื่อสร้างสังคม<br>แห่งการแบ่งปันพร้อมทั้งต่อยอดธุรกิจ<br>ในหลากหลายแพลตฟอร์ม ยกระดับธุรกิจให้เติบโต<br>และสร้างรากฐานที่มั่นคง เตรียมศักยภาพความพร้อม<br>ในการแข่งขันที่เพิ่มขึ้นในอนาคต';
};
